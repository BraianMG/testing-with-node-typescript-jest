...
jest.mock('../../../app/server_app/utils/Utils', () => ({
  // In the next line we do this instead of `getRequestBody: getRequestBodyMock`, because `getRequestBodyMock` is initialized outside of `jest.mock()` and thus we avoid the error that the mock does not exist in `const getRequestBodyMock = jest.fn( );`
