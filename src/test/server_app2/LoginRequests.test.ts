...
describe('Login requests', () => {
  ...
  it('should login user with valid credentials', async () => {
    ...
    await new Promise(process.nextTick); // this solves timing issues (https://stackoverflow.com/questions/44741102/how-to-make-jest-wait-for-all-asynchronous-code-to-finish-execution-before-expec)
